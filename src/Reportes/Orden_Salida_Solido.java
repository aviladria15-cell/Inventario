...
public class Orden_Salida_Solido {
    ...
    public void generarPDFOrdenSalidaSolido(int cantidad, BigDecimal precioUnitario,
        ...
        if (seleccionado == null) {
            JOptionPane.showMessageDialog(null, "Debe seleccionar un producto sólido", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try (PDDocument document = new PDDocument()) {
            ...
            try (PDPageContentStream contentStream = new PDPageContentStream(document, page)) {
                ...
                contentStream.setFont(PDType1Font.HELVETICA, 10);
                drawText(contentStream, rightInfoX + 80, y, "OSS-" + System.currentTimeMillis() / 100000);
    ...
    private void guardarArchivo(PDDocument document) throws IOException {
        ...
        fileChooser.setSelectedFile(new File("SAP_Orden_Salida_Solido_" + System.currentTimeMillis() / 1000 + ".pdf"));
